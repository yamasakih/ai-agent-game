...
export function CountUpSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-4">
      ...
      <button
        onClick={handleStart}
        className="px-8 py-3 rounded-xl text-lg font-bold transition-all duration-200 bg-cyan-500 hover:bg-cyan-400 text-black shadow-lg hover:shadow-xl cursor-pointer"
      >
        Start
      </button>
    </div>
